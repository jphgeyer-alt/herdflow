...
/** "5 minutes ago" / "3 days ago" style relative timestamp, for activity
 * feeds -- falls back to a plain date once something is over a week old,
 * since "12 days ago" is less useful than the actual date at that point. */
