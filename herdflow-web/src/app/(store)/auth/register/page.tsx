    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f5f4ef] px-4 py-12">
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-[#e4ebf5] bg-white p-8 shadow-xl">
          <h1 className="mb-2 text-3xl font-black text-[#1B3A6B]">Create Account</h1>
          <p className="mb-8 text-sm text-[#5d7497]">Join the HerdFlow community</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="mb-3 block text-sm font-semibold text-[#244367]">
                Account Type
              </label>
                ...
                {[
                  ...
                  >
                    <input
                      ...
                      className="h-4 w-4 text-[#2E7D32] focus:ring-[#2E7D32]"
                    />
            ...
            <label className="flex cursor-pointer items-start gap-3">
              ...
              <span className="text-xs text-[#5d7497]">
                ...
                <Link href="/terms" className="font-semibold text-[#2E7D32] hover:underline">
                  Terms of Service
                </Link>{" "}
                and{" "}
          ...
          <div className="mt-6 border-t border-[#e4ebf5] pt-6 text-center">
