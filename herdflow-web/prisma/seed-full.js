...
async function seed() {
  ...
  const sellers = [
    { name: 'Thabo\'s Premium Cattle', region: 'Gauteng', location: 'Pretoria', phone: '+27101234567', nid: '9101015801080' },
    { name: 'KwaZulu Livestock Co', region: 'KwaZulu-Natal', location: 'Durban', phone: '+27312345678', nid: '8905045801081' },
    { name: 'Eastern Cape Farming', region: 'Eastern Cape', location: 'Port Elizabeth', phone: '+27413456789', nid: '9203125801082' }
  ];
  ...
  const products = [
    { name: 'Grass-Fed Beef (10kg)', price: 189900, sellerId: sellerIds[0], catId: categories[0].id },
    { name: 'Boerbok Meat (5kg)', price: 89900, sellerId: sellerIds[1], catId: categories[0].id },
    { name: 'Free-Range Chicken (2kg)', price: 34900, sellerId: sellerIds[2], catId: categories[0].id },
    { name: 'Organic Sheep Meat (8kg)', price: 139900, sellerId: sellerIds[0], catId: categories[0].id },
    { name: 'Premium Milk 1L', price: 8900, sellerId: sellerIds[1], catId: categories[1].id },
    { name: 'Livestock Feed (50kg)', price: 45900, sellerId: sellerIds[2], catId: categories[1].id },
    ...
    { name: 'Veterinary Antibiotics', price: 19900, sellerId: sellerIds[0], catId: categories[2].id },
  ];
  ...
  const orders = [
    ...
    { items: [[productIds[1], 1], [productIds[2], 3]] }, // 1x Boerbok + 3x Chicken
    { items: [[productIds[3], 1]] }, // 1x Sheep Meat
    { items: [[productIds[4], 6], [productIds[7], 2]] }, // 6x Milk + 2x Eggs
    { items: [[productIds[5], 1], [productIds[8], 1]] }, // Feed + Supplements
  ];
  ...
  const bannerConfig = [
    ...
    { key: 'banner_subheading', value: 'Fresh, grass-fed meat and dairy products delivered to your door' },
    { key: 'banner_image_url', value: 'https://images.unsplash.com/photo-1560493676-04071c5f467b?w=1200&h=400&fit=crop' },
